...
type PanelSettings struct {
	XMLName xml.Name `xml:"panelSettings"`
...
type GetVServerNicknameResponse struct {
	XMLName xml.Name `xml:"getVServerNicknameResponse"`
...
type SetVServerNicknameResponse struct {
	XMLName xml.Name `xml:"setVServerNicknameResponse"`
